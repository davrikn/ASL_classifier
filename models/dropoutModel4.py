...
class DropoutModel(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv5 = nn.Conv2d(64, self.final_conv_output, kernel_size=5, stride=1, padding=2)
        self.fc1 = nn.Linear(self.final_conv_output * 24 * 24, 256) # 192/2^-3 = 24
        self.dropout1 = nn.Dropout(p=0.5)
        self.fc2 = nn.Linear(256, 256) # 192/2^-3 = 24
